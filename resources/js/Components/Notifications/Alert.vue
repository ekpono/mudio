                        ...
                        <div class="flex items-start">
                            <div class="ml-3 w-0 flex-1 pt-0.5">
                                ...
                                <div class="mt-3 flex space-x-7">
                                    <Link :href="route('login')" type="button" class="rounded-md bg-white text-sm font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Sign In</Link>
                                </div>
                            </div>
...
defineProps({
    title: {
        type: String,
        default: 'Want to continue?'
    },
    description: {
        type: String,
        default: 'Sign to continue'
    },
    show: {
        type: Boolean,
        default: true
