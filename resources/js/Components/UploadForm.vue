    ...
    <section id="app" class="bg-white">
        <div class=" overflow-hidden">
            <div class="max-w-screen-xl mx-auto text-center">
                    ...
                    >
                        <div class="mt-2 sm:mt-0 sm:col-span-2">
                            <div
                                ...
                                class="relative w-full flex justify-center items-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md h-128"
                            >
                                <input
                                    type="file"
                                    multiple
                ...
                <div class="mt-4" v-if="largeFiles.length > 0">
                    <h5
                        class="text-left text-sm font-semibold text-primary-gray"
                    >
                        The following file(s) cannot be uploaded because they're
                        too large:
                    </h5>
                    <div class="flex items-center gap-2">
                        <span
                            class="leading-5 text-xs font-medium text-pink-600 truncate"
...
export default {
    ...
    methods: {
        ...
        droppedFiles(e) {
            ...
            this.droppedFileValidator([...droppedFiles]);

            this.$emit("video-updated", this.files[0]);
        },
        droppedFileValidator(files) {
            ...
            files.forEach((file) => {
                ...
                console.log("Ext: ", ext);
                // use ext to check for file extension in the condition
